package com.ngonyoku.mycrypto.presentation.coin_detail.components
...
import com.ngonyoku.mycrypto.data.remote.dto.TeamMember

/**
 * Individual List item of members
 * */
@Composable
fun TeamListItem(
